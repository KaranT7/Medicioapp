...
import 'package:finalmedicio/makeaccount/makehospital.dart';
...
class _HospitalScreenState extends State<HospitalScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Center(child: Text("Hospital Login",style: TextStyle(
          color: Colors.white,
          fontWeight: FontWeight.bold,
          fontSize: 20
      ))),
          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              child: Form(key: _formkey,
                child: Column(
                    children: <Widget>[
                      CircleAvatar(radius:60 ,child: Image.asset("assets/images/hospital.png")),
                      SizedBox(height: 20),
                      emailfield,
                      SizedBox(height: 20),
                      passwordfield,
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>MakeHospital()));
                              },
